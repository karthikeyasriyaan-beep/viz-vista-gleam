...
import { ArrowLeft, ArrowRight, HelpCircle, Shield, CreditCard, Smartphone, Lock, Wallet, Target, BarChart3 } from "lucide-react";
              ...
              <CardContent className="p-6">
                <div className="flex flex-wrap gap-3">
                  {[
                    ...
                    <span
                      key={tag}
                      className="text-xs font-medium text-muted-foreground border border-border/50 rounded-full px-3 py-1 bg-background/60"
                    >
                      {tag}
                    </span>
                  ))}
            ...
            <Card>
              <CardContent className="p-6 sm:p-8">
                ...
                <div className="grid sm:grid-cols-2 gap-8">
                  <div>
                    <h3 className="font-semibold text-foreground mb-3">What Trackora Offers</h3>
                    <div className="flex flex-wrap gap-2">
                      {[
                        ...
                        <span
                          key={item}
                          className="text-xs font-medium text-muted-foreground border border-border/50 rounded-full px-3 py-1 bg-muted/40"
                        >
                          {item}
                        </span>
                      ))}
            ...
            <Card className="bg-gradient-to-br from-primary/10 to-accent/10 border-primary/20">
              <CardContent className="p-8 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <a href="mailto:trackorateam@trackorapp.in">
